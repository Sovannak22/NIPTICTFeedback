...
public class PublicFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.profile_fragment_public,container,false);

        swipeRefreshLayout = v.findViewById(R.id.swipe_refresh_public_feed_profile);
        swipeRefreshLayout.setOnRefreshListener(this);
        swipeRefreshLayout.setColorSchemeResources(R.color.colorPrimary);

        alertPopUp = v.findViewById(R.id.alert_popup_public_feed_profile);
        feedBacks = new ArrayList<>();
        recyclerView = v.findViewById(R.id.rcl_public_feed_profiler);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        noPostFound = v.findViewById(R.id.no_new_found_public_feed_profile);
